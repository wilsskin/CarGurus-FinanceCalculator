    ...
    <div className="min-h-screen bg-[#F7F8FB] flex flex-col font-sans max-w-md mx-auto w-full">
        ...
        <div className="max-w-md mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-2 ml-[-8px]">
            <button
              ...
              aria-label="Back"
            >
              <ArrowLeft className="w-5 h-5 text-[#0578BB]" />
            </button>
            <h1 className="text-xl font-extrabold text-[#0578BB] tracking-tight">Finance Calculator</h1>
          </div>
          <div>
            <button
              className="text-[#0578BB] text-base font-bold flex items-center"
              aria-label="Options"
            >
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-[#E6E8EB] shadow-lg">
        <div className="flex justify-around max-w-md mx-auto py-2">
          <button className="flex flex-col items-center text-[#0578BB] px-2">
